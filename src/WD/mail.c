...
static struct one_key mail_comms[] = {
  'z', man,		 0, "¶i¤J¨p¤H«H¥ó§¨",
  'c', cite,		 0, "±N¦¹«H¥ó¶i¤J¨p¤H«H¥ó§¨",
  'C', gem_tag,		 0, "gem_tag",
  's', mail_save,	 0, "mail_save",
  'd', mail_del,	 0, "±þ±¼¦¹«H",
  'D', del_range,	 0, "±þ±¼«ü©w½d³òªº«H",
  'r', mail_read,	 0, "Åª«H",
  'R', mail_reply,	 0, "¦^ÂÐ«H¥ó",
  'E', edit_post,	 0, "½s¿è¤å¥ó",
  'm', mark,		 0, "±N«H¥ó¼Ð°O, ¥H¨¾«H¥ó³Q²M°£",
  't', add_tag,		 0, "¼Ð°O¸Ó«H¥ó",
  'T', edit_title,	 0, "½s¿è¼ÐÃD",
  'x', m_forward,	 0, "Âà¹F«H¥ó",
  'X', mail_cross_post,	 0, "Âà¿ý¤å³¹¨ì¨ä¥L¬ÝªO",
  Ctrl('D'), del_tag,	 0, "§R°£¤w¼Ð°O«H¥ó",
  'y', multi_reply,  	 0, "¸s²Õ¦^«H",
  'F', post_mail,	 0, "±N«H¶Ç°e¦^±zªº¹q¤l«H½c",
  Ctrl('Q'), post_query, 0, "q ¸Ó«H¤H",
  '\0', NULL, 0, NULL
};
