...
static struct one_key mail_comms[] = {
  'z', man,		 "¶i¤J¨p¤H«H¥ó§¨",
  'c', cite,		 "±N¦¹«H¥ó¶i¤J¨p¤H«H¥ó§¨",
  'C', gem_tag,		 "gem_tag",
  's', mail_save,	 "mail_save",
  'd', mail_del,	 "±þ±¼¦¹«H",
  'D', del_range,	 "±þ±¼«ü©w½d³òªº«H",
  'r', mail_read,	 "Åª«H",
  'R', mail_reply,	 "¦^ÂÐ«H¥ó",
  'E', edit_post,	 "½s¿è¤å¥ó",
  'm', mark,		 "±N«H¥ó¼Ð°O, ¥H¨¾«H¥ó³Q²M°£",
  't', add_tag,		 "¼Ð°O¸Ó«H¥ó",
  'T', edit_title,	 "½s¿è¼ÐÃD",
  'x', m_forward,	 "Âà¹F«H¥ó",
  'X', mail_cross_post,	 "Âà¿ý¤å³¹¨ì¨ä¥L¬ÝªO",
  Ctrl('D'), del_tag,	 "§R°£¤w¼Ð°O«H¥ó",
  'y', multi_reply,  	 "¸s²Õ¦^«H",
  'F', post_mail,	 "±N«H¶Ç°e¦^±zªº¹q¤l«H½c",
  Ctrl('Q'), post_query, "q ¸Ó«H¤H",
  '\0', NULL, NULL
};
