...
KEY_LEFT, NULL, "Â÷¶}¡C        ¨ä¥L¬Û¦Pªº«öÁä: q, e",
KEY_UP,   NULL, "´å¼Ð¦V¤W¡C    ¨ä¥L¬Û¦Pªº«öÁä: p, k",
KEY_DOWN, NULL, "´å¼Ð¦V¤U¡C    ¨ä¥L¬Û¦Pªº«öÁä: n, j",
KEY_PGDN, NULL, "¤U¤@­¶¡C      ¨ä¥L¬Û¦Pªº«öÁä: ªÅ¥ÕÁä, N, Ctrl+f",
KEY_PGUP, NULL, "¤W¤@­¶¡C      ¨ä¥L¬Û¦Pªº«öÁä: P, Ctrl+b",
KEY_END,  NULL, "¸õ¨ì³Ì«á¤@¶µ¡C¨ä¥L¬Û¦Pªº«öÁä: $",
KEY_RIGHT,NULL, "°õ¦æ, ¾\\Åª¡C  ¨ä¥L¬Û¦Pªº«öÁä: Enter",
'\0', NULL, NULL};


/* ¥DÃD¦¡¾\Åª«ü¥O¶° */
struct one_key sub_key[]={
'/',      NULL, "§ä´M¼ÐÃD¡C              ¨ä¥L¬Û¦Pªº«öÁä: ?",
'S',      NULL, "´`§Ç¾\\Åª·s¤å³¹¡C",
'L',      NULL, "¾\\Åª«DÂà«H¤å³¹¡C",
'u',      NULL, "¼ÐÃD¦¡¾\\Åª¡C",
'=',      NULL, "§ä´M­º½g¤å³¹¡C",
'\\',     NULL, "§ä´M´å¼Ð¸Ó³B¤§­º½g¤å³¹¡C",
'[',	  NULL, "¦V«e·j´M¬Û¦P¼ÐÃD¤§¤å³¹¡C¨ä¥L¬Û¦Pªº«öÁä: +",
']',	  NULL, "¦V«á·j´M¬Û¦P¼ÐÃD¤§¤å³¹¡C¨ä¥L¬Û¦Pªº«öÁä: -",
'<',	  NULL, "¦V«e·j´M¨ä¥L¼ÐÃD¡C      ¨ä¥L¬Û¦Pªº«öÁä: ,",
'>',	  NULL, "¦V«á·j´M¨ä¥L¼ÐÃD¡C      ¨ä¥L¬Û¦Pªº«öÁä: .",
'A', 	  NULL, "·j´M§@ªÌ¡C              ¨ä¥L¬Û¦Pªº«öÁä: a",
'X',	  NULL, "©Ò¦³³Q¥[¤À¹Lªº¤å³¹¡C",
'G',	  NULL, "©Ò¦³³Q mark ¹Lªº¤å³¹¡C",
'\0', NULL, NULL};
  ...
  while(1)
  {
    ...
    switch(ch)
    {
      ...
      case KEY_RIGHT:
      {
        ...
        sprintf(buf,"½Ð°Ý§A¬O§_­n°õ¦æ %s ?", rcmdlist[cursor].help);
