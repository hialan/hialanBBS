  ...
  int sr_mode;
{
  ...
  else if (sr_mode == RS_FIRST)
  {
    ...
    munmap(fimage, fsize);	// sby: °O¾ÐÅé·|¶V¦Y¶V¦h @@"
...
KEY_LEFT, NULL, 0, "Â÷¶}¡C        ¨ä¥L¬Û¦Pªº«öÁä: q, e",0,
KEY_UP,   NULL, 0, "´å¼Ð¦V¤W¡C    ¨ä¥L¬Û¦Pªº«öÁä: p, k",0,
KEY_DOWN, NULL, 0, "´å¼Ð¦V¤U¡C    ¨ä¥L¬Û¦Pªº«öÁä: n, j",0,
KEY_PGDN, NULL, 0, "¤U¤@­¶¡C      ¨ä¥L¬Û¦Pªº«öÁä: ªÅ¥ÕÁä, N, Ctrl+f",0,
KEY_PGUP, NULL, 0, "¤W¤@­¶¡C      ¨ä¥L¬Û¦Pªº«öÁä: P, Ctrl+b",0,
KEY_END,  NULL, 0, "¸õ¨ì³Ì«á¤@¶µ¡C¨ä¥L¬Û¦Pªº«öÁä: $",0,
KEY_RIGHT,NULL, 0, "°õ¦æ, ¾\\Åª¡C  ¨ä¥L¬Û¦Pªº«öÁä: Enter",0,
'\0', NULL, 0, NULL,0};


/* ¥DÃD¦¡¾\Åª«ü¥O¶° */
struct one_key sub_key[]={
'/',      NULL, 0, "§ä´M¼ÐÃD¡C              ¨ä¥L¬Û¦Pªº«öÁä: ?",0,
'S',      NULL, 0, "´`§Ç¾\\Åª·s¤å³¹¡C",0,
'L',      NULL, 0, "¾\\Åª«DÂà«H¤å³¹¡C",0,
'u',      NULL, 0, "¼ÐÃD¦¡¾\\Åª¡C",0,
'=',      NULL, 0, "§ä´M­º½g¤å³¹¡C",0,
'\\',     NULL, 0, "§ä´M´å¼Ð¸Ó³B¤§­º½g¤å³¹¡C",0,
'[',	  NULL, 0, "¦V«e·j´M¬Û¦P¼ÐÃD¤§¤å³¹¡C¨ä¥L¬Û¦Pªº«öÁä: +",0,
']',	  NULL, 0, "¦V«á·j´M¬Û¦P¼ÐÃD¤§¤å³¹¡C¨ä¥L¬Û¦Pªº«öÁä: -",0,
'<',	  NULL, 0, "¦V«e·j´M¨ä¥L¼ÐÃD¡C      ¨ä¥L¬Û¦Pªº«öÁä: ,",0,
'>',	  NULL, 0, "¦V«á·j´M¨ä¥L¼ÐÃD¡C      ¨ä¥L¬Û¦Pªº«öÁä: .",0,
'A', 	  NULL, 0, "·j´M§@ªÌ¡C              ¨ä¥L¬Û¦Pªº«öÁä: a",0,
'X',	  NULL, 0, "©Ò¦³³Q¥[¤À¹Lªº¤å³¹¡C",0,
...
struct one_key *rcmdlist;
{
  ...
  do
  {
    ...
    case RC_BODY:
      if (last_line < locmem->top_ln + p_lines) //·íµe­±¦³Åã¥Ü³Ì«á¤@¶µ
      {						//¤~§ó·s last_line
