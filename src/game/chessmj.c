...
static inline void zkey()        /* press any key or timeout */
{
...
void zmsg(char *msg)                         /* easy message */
{
...
int testthree(int a,int b,int c)
{
  int tmp;
...
int diecard(int a) /* ¶Ç¶i¤@±iµP, ¬Ý¬O§_µ´±i */
{
  int i,k=0;
  for(i=0;i<tflag;i++){
...
int count_tai(int set[5], int win)
{
  int i,j=0,sum=0;
